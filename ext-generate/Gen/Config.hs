...
--   parseJSON = withObject "ColorsTheme" $ \v ->
--     ColorsTheme
--       <$> v .:? "palette"
--       <*> v .:? "aliases"
--       <*> v .:? "text"
...
--   parseJSON = withObject "ColorAliasTheme" $ \v ->
--     ColorAliasTheme
--       <$> v .: "neutral"
--       <*> v .: "primary"
--       <*> v .:? "focus"
...
--     object
--       [ "font" .= fontFamily,
--         "capitalSizing" .= fontCapitalSizing,
--         "sizes" .= fontSizes
--       ]
...
-- instance FromJSON FontDetails where
--   parseJSON = withObject "FontDetails" $ \v ->
--     FontDetails
--       <$> v .: "size"
--       <*> v .:? "lineHeight"
--       <*> v .:? "weight"
...
-- instance ToJSON FontDetails where
--   toJSON FontDetails {..} =
--     object $
--       catMaybes
--         [ Just ("size", toJSON fontSize),
--           ("lineHeight",) . toJSON <$> fontLineHeight,
--           ("weight",) . toJSON <$> fontWeight,
--           ("weights",) . toJSON <$> fontWeights,
--           ("variant",) . toJSON <$> fontVariant,
--           ("variants",) . toJSON <$> fontVariants
--         ]
...
-- instance FromJSON BorderConfig where
--   parseJSON = withObject "BorderConfig" $ \v ->
--     BorderConfig
--       <$> v .:? "radius"
--       <*> v .:? "width"

-- instance ToJSON BorderConfig where
--   toJSON BorderConfig {..} =
--     object $
--       catMaybes
--         [ ("radius",) . toJSON <$> borderRadius,
--           ("width",) . toJSON <$> borderWidth
--         ]
...
instance FromJSON GraphQLConfig where
  parseJSON = withObject "GraphQLConfig" $ \v ->
    GraphQLConfig
      <$> v .: "schema"
      <*> v .:? "namespace"
      <*> v .: "header"
