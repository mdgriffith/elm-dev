  ...
  let
    ...
    makeFlags =
      flags Make.Flags
        ...
        |-- onOff "O2" "Turn on level 2 JavaScript optimizations. This includes direct compiler code generation for optimizations ported from elm-optimize-level-2. You can use this as -O2 or --O2."
        |-- onOff "O3" "Turn on level 3 JavaScript optimizations. This includes O2 plus speed-focused optimizations that may increase JavaScript size. You can use this as -O3 or --O3."
