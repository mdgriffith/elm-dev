...
rm packages/win32_x64/elm-dev # Remove the directory after extraction
...
for dir in packages/linux-arm64 packages/linux-x64 packages/darwin-arm64 packages/darwin-x64 packages/win32-x64; do
