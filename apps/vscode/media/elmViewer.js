...
var $author$project$Model$NoData = {$: 'NoData'};
var $elm$core$Maybe$Nothing = {$: 'Nothing'};
var $author$project$Model$PortMessageDecodeError = function (a) {
	return {$: 'PortMessageDecodeError', a: a};
};
...
var $author$project$Model$CodeViewChanged = function (a) {
	return {$: 'CodeViewChanged', a: a};
};
var $author$project$Model$GotErrors = function (a) {
	return {$: 'GotErrors', a: a};
};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Model$Region = F2(
	function (start, end) {
...
var $author$project$Model$decodeRegion = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Model$Region,
...
var $author$project$Model$CompilerError = function (a) {
	return {$: 'CompilerError', a: a};
};
var $author$project$Model$Error = function (a) {
	return {$: 'Error', a: a};
};
var $author$project$Model$GlobalError = F2(
	function (path, problem) {
		return {path: path, problem: problem};
	});
var $author$project$Model$Success = {$: 'Success'};
var $author$project$Model$Many = {$: 'Many'};
var $author$project$Model$Single = {$: 'Single'};
var $elm$json$Json$Decode$fail = _Json_fail;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Model$decodeErrorType = A2(
	$elm$json$Json$Decode$andThen,
	function (str) {
		switch (str) {
			case 'error':
				return $elm$json$Json$Decode$succeed($author$project$Model$Single);
			case 'compile-errors':
				return $elm$json$Json$Decode$succeed($author$project$Model$Many);
			default:
				return $elm$json$Json$Decode$fail('Unsupported error type: ' + str);
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$Model$FileError = F3(
	function (path, name, problem) {
		return {name: name, path: path, problem: problem};
	});
var $author$project$Model$Problem = F3(
	function (title, message, region) {
		return {message: message, region: region, title: title};
	});
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$Model$Plain = function (a) {
	return {$: 'Plain', a: a};
};
var $author$project$Model$Styled = function (a) {
	return {$: 'Styled', a: a};
};
var $author$project$Model$StyledText = F4(
...
var $author$project$Model$maybeColor = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$andThen,
			function (val) {
				...
				switch (_v0) {
					...
					case 'GREEN':
						return $elm$json$Json$Decode$succeed(
							$elm$core$Maybe$Just($author$project$Model$Green));
					case '':
...
var $author$project$Model$styledText = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Model$StyledText,
...
var $author$project$Model$text = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2($elm$json$Json$Decode$map, $author$project$Model$Plain, $elm$json$Json$Decode$string),
			A2($elm$json$Json$Decode$map, $author$project$Model$Styled, $author$project$Model$styledText)
		]));
var $author$project$Model$decodeProblem = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Model$Problem,
	A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'message',
		$elm$json$Json$Decode$list($author$project$Model$text)),
	A2($elm$json$Json$Decode$field, 'region', $author$project$Model$decodeRegion));
var $author$project$Model$fileError = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Model$FileError,
	A2($elm$json$Json$Decode$field, 'path', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'problems',
		$elm$json$Json$Decode$list($author$project$Model$decodeProblem)));
var $author$project$Model$error = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			$elm$json$Json$Decode$null($author$project$Model$Success),
			A2(
			$elm$json$Json$Decode$andThen,
			function (errorType) {
				if (errorType.$ === 'Single') {
						...
						A4(
							...
							F3(
								function (path, title, message) {
									return A2(
										$author$project$Model$GlobalError,
										path,
					...
					return A2(
						$elm$json$Json$Decode$map,
						function (err) {
							return $author$project$Model$CompilerError(
								{errors: err});
						},
						A2(
							$elm$json$Json$Decode$field,
							'errors',
							$elm$json$Json$Decode$list($author$project$Model$fileError)));
				}
			},
			A2($elm$json$Json$Decode$field, 'type', $author$project$Model$decodeErrorType))
		]));
...
var $author$project$Model$editorMessageDecoder = A2(
	...
	function (command) {
		switch (command) {
			case 'CodeViewChanged':
				return A4(
					$elm$json$Json$Decode$map3,
					F3(
						function (fileName, selections, ranges) {
							return $author$project$Model$CodeViewChanged(
					...
					A2(
						$elm$json$Json$Decode$field,
						'ranges',
						$elm$json$Json$Decode$list($author$project$Model$decodeRegion)));
			case 'ElmMake':
				return A2(
					$elm$json$Json$Decode$map,
					$author$project$Model$GotErrors,
					A2($elm$json$Json$Decode$field, 'json', $author$project$Model$error));
			default:
				return $elm$json$Json$Decode$fail('Unrecognized Message');
		}
	},
...
var $author$project$Model$elmMake = function (details) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'command',
				$elm$json$Json$Encode$string('ElmMake')),
				_Utils_Tuple2(
				'root',
				$elm$json$Json$Encode$string(details.root)),
				_Utils_Tuple2(
				'filepath',
				$elm$json$Json$Encode$string(details.filepath))
			]));
};
var $elm$core$Platform$Sub$map = _Platform_map;
var $author$project$Main$notify = _Platform_outgoingPort('notify', $elm$core$Basics$identity);
var $elm$json$Json$Encode$int = _Json_wrap;
var $author$project$Model$encodePos = function (pos) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Model$encodeRange = function (rng) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'start',
				$author$project$Model$encodePos(rng.start)),
				_Utils_Tuple2(
				'end',
				$author$project$Model$encodePos(rng.end))
			]));
};
var $author$project$Model$encodeGoto = function (details) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'file',
							$elm$json$Json$Encode$string(details.file)),
							_Utils_Tuple2(
							'range',
							$author$project$Model$encodeRange(details.range))
						])))
			]));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_v0.$) {
			case 'PortMessageDecodeError':
				var err = _v0.a;
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'CodeViewChanged':
				var current = _v0.a;
				var newViewing = function () {
					var _v1 = model.viewing;
					if (_v1.$ === 'Nothing') {
						return $elm$core$Maybe$Just(
			...
			default:
				...
				return _Utils_Tuple2(
					...
					$author$project$Main$notify(
						$author$project$Model$encodeGoto(details)));
		}
	});
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Main$viewFileName(selected.file))
									]))
							]));
				}
			}()
...
var $author$project$Main$viewText = function (txt) {
	if (txt.$ === 'Plain') {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(styled.string)
				]));
	}
};
...
var $author$project$Model$overlap = F2(
	function (one, two) {
...
var $author$project$Model$visible = F2(
	function (rng, viewing) {
		return A2(
			$elm$core$List$any,
			$author$project$Model$overlap(rng),
			viewing);
	});
var $author$project$Main$viewIssueInRange = F2(
	function (maybeViewing, iss) {
		if (maybeViewing.$ === 'Nothing') {
			return $elm$html$Html$text('');
		} else {
			var viewing = maybeViewing.a;
			return A2($author$project$Model$visible, iss.region, viewing.visible) ? A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$Main$viewFileIssue = F2(
	function (viewing, fileIssue) {
		return A2(
			$elm$core$List$map,
			$author$project$Main$viewIssueInRange(viewing),
			fileIssue.problem);
	});
...
var $author$project$Model$GoTo = function (a) {
	return {$: 'GoTo', a: a};
};
var $author$project$Model$documentStart = {col: 0, row: 0};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Model$GoTo(
						{
							file: file.path,
							range: A2(
								$elm$core$Maybe$withDefault,
								{end: $author$project$Model$documentStart, start: $author$project$Model$documentStart},
								A2(
									$elm$core$Maybe$map,
									function ($) {
										return $.region;
									},
									$elm$core$List$head(file.problem)))
						})),
					A2($elm$html$Html$Attributes$style, 'curosor', 'pointer')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(file.name + '.elm'),
					A2(
					$elm$html$Html$div,
					_List_Nil,
					A2(
						...
						$elm$core$Dict$toList(
							A3($elm$core$List$foldl, countTitleOccurances, $elm$core$Dict$empty, file.problem))))
				]));
	};
	return A2(
		$elm$html$Html$div,
	...
	function (viewing, error) {
		switch (error.$) {
			...
			case 'Error':
				...
				return (_Utils_eq(
					$elm$core$Maybe$Just(err.path),
					A2(
						$elm$core$Maybe$map,
						function ($) {
							return $.file;
						},
						viewing)) || _Utils_eq(viewing, $elm$core$Maybe$Nothing)) ? _List_fromArray(
					[
						A2($author$project$Main$viewIssue, viewing, err.problem)
					]) : _List_Nil;
			default:
				...
				if (!errorsForFile.b) {
					...
					return _Utils_ap(
						A2(
							...
							$author$project$Main$viewFileIssue(viewing),
							errorsForFile),
						_List_fromArray(
							[
								A2(
...
var $author$project$Model$aboveRange = F2(
	function (shouldBeAbove, two) {
		return _Utils_cmp(shouldBeAbove.end.row, two.start.row) < 0;
	});
var $author$project$Model$above = F2(
	function (rng, viewing) {
		return A2(
			$elm$core$List$any,
			$author$project$Model$aboveRange(rng),
			viewing);
	});
var $author$project$Main$onlyAbove = F2(
	function (maybeViewing, iss) {
		if (maybeViewing.$ === 'Nothing') {
			...
			var viewing = maybeViewing.a;
			return A2($author$project$Model$above, iss.region, viewing.visible);
		}
	});
...
var $author$project$Model$belowRange = F2(
	function (shouldBeBelow, two) {
		return _Utils_cmp(shouldBeBelow.start.row, two.end.row) > 0;
	});
var $author$project$Model$below = F2(
	function (rng, viewing) {
		return A2(
			$elm$core$List$all,
			$author$project$Model$belowRange(rng),
			viewing);
	});
var $author$project$Main$onlyBelow = F2(
	function (maybeViewing, iss) {
		if (maybeViewing.$ === 'Nothing') {
			...
			var viewing = maybeViewing.a;
			return A2($author$project$Model$below, iss.region, viewing.visible);
		}
	});
...
var $author$project$Main$view = function (model) {
	return {
		body: A2(
			...
			A2(
				$elm$core$List$cons,
				$author$project$Main$viewEditorFocusToken(model.viewing),
				A2(
					$elm$core$List$cons,
					A2($author$project$Main$viewErrorCountHints, model.viewing, model.diagnostics),
					A2($author$project$Main$viewError, model.viewing, model.diagnostics)))),
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
				{diagnostics: $author$project$Model$NoData, viewing: $elm$core$Maybe$Nothing},
				$author$project$Main$notify(
					$author$project$Model$elmMake(
						{filepath: 'src/Main.elm', root: './elm'})));
		},
				...
				_List_fromArray(
					[
						...
						function (decodeResult) {
							if (decodeResult.$ === 'Ok') {
								var msg = decodeResult.a;
								return msg;
							} else {
								var err = decodeResult.a;
								return $author$project$Model$PortMessageDecodeError(err);
							}
						},
						$author$project$Main$editorChange(
							$elm$json$Json$Decode$decodeValue($author$project$Model$editorMessageDecoder)))
					]));
		},
