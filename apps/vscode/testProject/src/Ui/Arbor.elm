...
layedOut =
    Hierarchy.tidy
        ...
        , Hierarchy.parentChildMargin 100
        ...
        |> Tree.sumUp
            (\n ->
                ...
                , height = n.height
                , node = n.node
                , bbox = { x = n.y, y = n.x, width = n.width, height = n.height }
                }
            )
            (\n c ->
                { x = n.y
                ...
                , node = n.node
                , bbox =
                    List.foldl (\item t -> maxBBoxes item.bbox t)
                        { x = n.x
                        , y = n.y
                        , width = n.width
                        , height = n.height
