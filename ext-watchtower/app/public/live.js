		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$author$project$Ui$pad.xy.xl.md, $author$project$Ui$precise]),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
				$author$project$Ui$when,
				!$elm$core$List$isEmpty(found.globals),
				$author$project$Ui$header.three('Global')),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[$author$project$Ui$space.lg]),
				...
				A2(
				$author$project$Ui$when,
				!$elm$core$List$isEmpty(found.errs),
