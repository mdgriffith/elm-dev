...
resolveProject mProjectId (Client.State _ mProjects _ _ _ _ _ _ _) = do
...
resolveProjectFromSession mProjectId connId st@(Client.State _ mProjects _ _ _ _ mEditorsOpen _ _) = do
  case mProjectId of
