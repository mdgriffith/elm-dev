...
websocket_ state@(Client.State mClients mProjects _ _ _ _ _ _ _) = do
...
receiveAction state@(Client.State mClients mProjects _ _ _ _ _ _ _) senderClientId incoming =
  case incoming of
...
broadCastToEveryoneNotMe (Client.State mClients _ _ _ _ _ _ _ _) myClientId =
